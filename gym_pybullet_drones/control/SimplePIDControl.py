...
class SimplePIDControl(BaseControl):
    """Generic PID control class with yaw control."""
    ...
    def _simplePIDPositionControl(self,
        ...
        target_rpy[2] = 0.  # The yaw will be controlled separately
    ...
    def _simplePIDAttitudeControl(self,
        ...
        rpy_e = computed_target_rpy - cur_rpy
        rpy_e[2] = target_rpy[2] - cur_rpy[2]  # Include yaw error
